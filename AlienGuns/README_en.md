...
_NOTE: all items IDs from this mod start from `"YukkuriC".GetHashCode() = 1206528349`, and all IDs shown below represents for the offset based on this_

## Contents

-   Mage Hand(#0)
    -   Fragment of mythical creature.
    -   Shoots scattered <span style="color=orange">**fire**</span> and relatively concentrated <span style="color=purple">**space**</span> bullets alternately.
-   Reversed RPG(#1)
    -   Generates explosion beneath player, and pushes player into air.
-   MP-155 PLAGUE(#2)
